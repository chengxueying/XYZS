...
public class MyProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mProductView = inflater.inflate(R.layout.fragment_lost, container, false);
        mSwipeRefreshLayout = (SwipeRefreshLayout) mProductView.findViewById(R.id.SwipeRefreshLayout_lost);
    ...
    private void initView() {
        mRecycleView = (RecyclerView) mProductView.findViewById(R.id.Recyclerview_lost);
				...
				public boolean OnItemLongClick(int position) {
					...
					builder.setMessage("确定要删除吗？").setTitle("温馨提示").setPositiveButton("确认", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								Product.setObjectId(mProductDatas.get(pos).getObjectId());
								Product.delete(getActivity(), new DeleteListener() {
