...
import xyzs.hy.com.xyzs.entity.Product;
...
public class ProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProductAdapter(Context context, ArrayList<Product> mProductDatas) {
        this.mProductDatas = mProductDatas;
    ...
    public int getItemViewType(int position) {
        if (mProductDatas.get(position).getStatus() == 0) {
            return FOOT_VIEW;
        } else if (mProductDatas.get(position).getStatus() == 1) {
            return ITEM_VIEW;
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ((ItemViewHolder) holder).tv_describe.setText(mProductDatas.get(position).getDescribe());
            ((ItemViewHolder) holder).tv_phone.setText(mProductDatas.get(position).getPhone());
            ((ItemViewHolder) holder).tv_name.setText(mProductDatas.get(position).getPublisher().getUsername());
            ((ItemViewHolder) holder).tv_name.setText(mProductDatas.get(position).getPublisher().getUsername());
            ((ItemViewHolder) holder).tv_title.setText(mProductDatas.get(position).getTitle());
            ((ItemViewHolder) holder).tv_time.setText(mProductDatas.get(position).getUpdatedAt());
            Uri uri = Uri.parse(mProductDatas.get(position).getPublisher().getHeadSculpture());
            ...
            ((MyViewHolder) holder).tv_describe.setText(mProductDatas.get(position).getDescribe());
            ((MyViewHolder) holder).tv_phone.setText(mProductDatas.get(position).getPhone());
            ((MyViewHolder) holder).tv_title.setText(mProductDatas.get(position).getTitle());
            ((MyViewHolder) holder).tv_name.setText(mProductDatas.get(position).getPublisher().getUsername());
            ((MyViewHolder) holder).tv_time.setText(mProductDatas.get(position).getUpdatedAt());
            Uri imageUri = Uri.parse(mProductDatas.get(position).getPublisher().getHeadSculpture());
            ((MyViewHolder) holder).head.setImageURI(imageUri);
            Uri uri = Uri.parse(mProductDatas.get(position).getImageURL());
    ...
    public int getItemCount() {
        return mProductDatas == null ? 0 : mProductDatas.size();
    }
    ...
    //刷新新数据
    public void addItem(List<Product> mNewData) {
        mProductDatas.clear();
        mProductDatas.addAll(mNewData);
        notifyDataSetChanged();
